...
> [!IMPORTANT]
> This file is auto-generated. Do not edit this file directly as changes will be overwritten.
...
- unlock-wechat [unlock-wechat](https://activebook.github.io/unlock-wechat/)
...
- tts-mcp-server [tts-mcp-server](https://activebook.github.io/tts-mcp-server/)
A Model Context Protocol (MCP) server that provides Text-to-Speech (TTS) functionality using Google TTS API.

- copilot_sidebar [copilot_sidebar](https://activebook.github.io/copilot_sidebar/)
...
- SakanaLens [SakanaLens](https://activebook.github.io/SakanaLens/)
